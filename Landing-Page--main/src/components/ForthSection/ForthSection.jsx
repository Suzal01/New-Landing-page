  ...
  return (
    <section className=" forth bg-white w-[100vw] h-[100vh] text-gray-800 py-12">
        ...
        <h2 className="text-4xl font-bold mb-2">Elevate Your Chat Experience Today</h2>
            ...
            <button className="absolute left-[1250px] top-[160px] bg-red-800 text-white py-4 px-8 rounded-full transition-colors duration-300 hover:bg-red-700 mt-4 lg:mt-0">Get Started</button>
      </div>
      <div className=" absolute container top-[2450px] mx-auto px-4 text-center">
        <h2 className="text-red-500 text-sm uppercase mb-2">Explore More</h2>
        <h1 className="text-4xl  bottom-[200px] font-bold mb-8">Dive Into The Chatting App <br /> Experience</h1>
