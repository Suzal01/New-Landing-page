    ...
    <div className="relative bg-white py-20">
      <div className="text-center">
        ...
        <div className="flex justify-center mt-8 space-x-8">
          ...
          <div className="text-center bg-white p-6 rounded-lg shadow-lg">
            <div className="text-red-800 font-bold text-3xl">“</div>
            <p className="mt-2">Chatit App has made online conversations feel more personal and secure. It’s my go-to platform for both work and staying in touch with friends.</p>
     ...
     <div className="text-center text-white">
       ...
       <h1 className="text-3xl font-bold mt-2">Start Chatting Smarter With Chatit Today</h1>
       <h4 className="text-lg font-normal mt-2">
         Experience the future of online communication with Chatit. Join now and revolutionize <br /> the way you chat!
       </h4>
